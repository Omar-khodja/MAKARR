...
import 'package:makarr/feature/Home/presentation/controler/not_subscriber.dart';
...
class _InvestorScreenState extends ConsumerState<InvestorScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final AsyncValue<UserNav> user = ref.watch(userNotifireProvider);


    return RefreshIndicator(
      onRefresh: () async {
        ref
            .read(investmentNotifireProvider.notifier).getInvestmentPost();
